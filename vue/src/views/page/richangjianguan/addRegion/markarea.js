...
$(function(){
    ...
    drawingManager.addEventListener('rectanglecomplete',function(e){
        ...
        strCoords+=']}';
        localStorage.setItem("coords",strCoords);
        //var dataRead = localStorage.getItem("coords");
    });
